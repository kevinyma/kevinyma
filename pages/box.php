	...
	<div class="slide boxslide" id="projectslide" data-slide="1" data-stellar-background-ratio="0.5">
		<div class="container clearfix">
			<div id="content" class="grid_12">
				...
				<h2 class="projecttitle">BOX!</h2>
				<p class="projectdescription">Analytics-driven Game Design, supervised by Professor Erik Anderson. 
				Thanks to the BOX! crew: Jeremy Cytryn, <a href="http://renchusong.github.io/portfolio/">Renchu Song</a>, 
				<a href="http://nndiebold.tumblr.com/">Natalie Diebold</a>, Sam Chen, and Will Peck. 
				I was responsible for user experience and visual design.
				</p>
				...
				<div class="grid_12 paragraph">
					<div class="grid_6">
					<p> This was an incredibly fun project. The thing with
					 flash games is you have a very brief window to grab a 
					 player’s attention. If you don’t, they’re gone forever. 
					 Off to play the hundreds of thousands of other flash games.
					</p>
					</div>
